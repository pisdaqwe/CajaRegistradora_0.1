...
public final class PersonalizacionDTO {
    ...
    public PersonalizacionDTO(int idPersonalizacion, String nombre, String tipo, BigDecimal precio) {
    ...
    public String toString() {
        return "PersonalizacionDTO{idPersonalizacion=" + idPersonalizacion
