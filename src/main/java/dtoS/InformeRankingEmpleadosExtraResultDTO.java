...
public class InformeRankingEmpleadosExtraResultDTO {

    private List<InformeRankingEmpleadosExtraRowDTO> rows = new ArrayList<>();
    ...
    public List<InformeRankingEmpleadosExtraRowDTO> getRows() {
        return rows;
    }

    public void setRows(List<InformeRankingEmpleadosExtraRowDTO> rows) {
        this.rows = rows;
    }
