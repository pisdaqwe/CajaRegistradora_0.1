...
public final class DbPool {
	...
	public static synchronized void init() {
		...
		try {
			...
			// 🔕 DESACTIVAR LOGGING VERBOSO DE HIKARI
			hKconfig.addDataSourceProperty("loggerLevel", "WARN");
	...
	public static Connection getConnection() throws SQLException {
		if (!initialized) {
			throw new IllegalStateException("DbPool no inicializado. Llama al DbPool.init()");
