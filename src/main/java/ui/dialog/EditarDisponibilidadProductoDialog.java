...
public class EditarDisponibilidadProductoDialog extends JDialog {
	...
	private void initComponents() {
		...
		txtStock.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(BORDER, 1, true),
	...
	private JComponent buildCenter() {
		...
		panel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(BORDER, 1, true),
		...
		gbc.gridwidth = 2;
		gbc.weightx = 1;
		JLabel help = new JLabel("<html><b>Reglas:</b><br>" + "- No disponible: el producto no se vende.<br>"
